...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp SIMARS UIN JAMBI</h4></a>
        ...
        ?>
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://th.bing.com/th/id/OIP.coEWeMFGwDxWH4t4vSjIZQHaHa?rs=1&pid=ImgDetMain" alt=""/>
                        <h3>Welcome</h3> 
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control"  placeholder="file*" id="file" name="file" onkeyup='check();' required/>
